...
export default function Detail_Return() {
  return (
  <section className="detail_payment_return">
    <h4 className="detail_title">교환 및 반품정보</h4>
    <hr className="justline"></hr>
    <br></br>
    <br></br>
    <p>교환 및 반품 주소</p>
    <p>- [04158] 서울특별시 마포구 마포대로 49 (도화동) 성우빌딩 1107-1109호</p>
    <br></br>
    <p>교환 및 반품이 가능한 경우</p>
